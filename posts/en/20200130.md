...
In this episode:
*  [The spectre of poor Rust compile times at PingCAP](https://pingcap.com/blog/rust-compilation-model-calamity/#the-spectre-of-poor-rust-compile-times-at-pingcap) 
*  [Preview: the TiKV compile-time adventure so far](https://pingcap.com/blog/rust-compilation-model-calamity/#preview-the-tikv-compile-time-adventure-so-far) 
*  [Rust’s designs for poor compilation time](https://pingcap.com/blog/rust-compilation-model-calamity/#rusts-designs-for-poor-compilation-time) 	◦	 [Bootstrapping Rust](https://pingcap.com/blog/rust-compilation-model-calamity/#bootstrapping-rust) 
	*  [(Un)virtuous cycles](https://pingcap.com/blog/rust-compilation-model-calamity/#unvirtuous-cycles) 
	*  [Early decisions that favored run-time over compile-time](https://pingcap.com/blog/rust-compilation-model-calamity/#early-decisions-that-favored-run-time-over-compile-time) 
*  [Recent work on Rust compile times](https://pingcap.com/blog/rust-compilation-model-calamity/#recent-work-on-rust-compile-times) 
*  [In the next episode](https://pingcap.com/blog/rust-compilation-model-calamity/#in-the-next-episode) 
*  [Thanks](https://pingcap.com/blog/rust-compilation-model-calamity/#thanks) 
